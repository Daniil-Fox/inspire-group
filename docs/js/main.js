...
/* harmony import */ var _components_accord_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/accord.js */ "./src/js/components/accord.js");
...
/* harmony import */ var _components_acc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/acc.js */ "./src/js/components/acc.js");
/* harmony import */ var _components_faq_height_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/faq-height.js */ "./src/js/components/faq-height.js");
/* harmony import */ var _components_footer_acc_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/footer-acc.js */ "./src/js/components/footer-acc.js");
...
/* harmony import */ var _components_validate_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/validate.js */ "./src/js/components/validate.js");
...
accordItems.forEach((item, i) => {
  ...
  btn.addEventListener('click', e => {
    ...
    content.style.maxHeight = content.scrollHeight + 'px';
    console.log(i);
    _sliders_js__WEBPACK_IMPORTED_MODULE_0__.projSlider.slideTo(i);
  });
});
...
/***/ "./src/js/components/faq-height.js":
/*!*****************************************!*\
  !*** ./src/js/components/faq-height.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/footer-acc.js":
/*!*****************************************!*\
  !*** ./src/js/components/footer-acc.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   projSlider: () => (/* binding */ projSlider)
/* harmony export */ });
...
testiContainers.forEach(cont => {
  ...
  const testiThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(thumbs, {
    slidesPerView: 4,
    spaceBetween: 10
  });
  const testiSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(main, {
    slidesPerView: 1,
    spaceBetween: 40,
    nested: true,
    thumbs: {
...
/* harmony import */ var _node_modules_inputmask_dist_inputmask_es6_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/inputmask/dist/inputmask.es6.js */ "./node_modules/inputmask/dist/inputmask.es6.js");
...
const validation = new just_validate__WEBPACK_IMPORTED_MODULE_1__["default"](quizFormWrap);
function setValidation(validator, rules, checks, phoneSelector, afterSend) {
  validator = new just_validate__WEBPACK_IMPORTED_MODULE_1__["default"](quizFormWrap);
  const telSelector = document.querySelector(phoneSelector);
  if (telSelector) {
    const inputMask = new _node_modules_inputmask_dist_inputmask_es6_js__WEBPACK_IMPORTED_MODULE_2__["default"]('+7 (999) 999-99-99');
  ...
  for (let item of rules) {
    validator.addField(item.ruleSelector, item.rules);
  }
  if (checks.length) {
    for (let item of checks) {
      validator.addRequiredGroup(`${item.selector}`, `${item.errorMessage}`);
    }
  }
